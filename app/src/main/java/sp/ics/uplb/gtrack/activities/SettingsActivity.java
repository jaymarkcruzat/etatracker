...
public class SettingsActivity extends AppCompatPreferenceActivity {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                if (TextUtils.isEmpty(stringValue)) {
                    ...
                    preference.setSummary(R.string.pref_alarm_tone_silent);
    ...
    public boolean onMenuItemSelected(int featureId, MenuItem item) {
        ...
        if (id == android.R.id.home) {
            if (!super.onMenuItemSelected(featureId, item)) {
                ...
                if (params!=null) {
                    String userNameParam = params.getString(Constants.USER_NAME);
                    String email = params.getString(Constants.USER_EMAIL);
                    if (userNameParam!=null && email!=null) {
                        SharedPreferences sharedPref = getSharedPreferences(Constants.SHARED_PREF, MODE_PRIVATE);
                        String userNamePref = sharedPref.getString(Constants.USER_NAME, null);
                        if (userNamePref!=null) {
                            if (!userNameParam.equals(userNamePref)) {
                                final String sqlStatement = "UPDATE USER SET USR_NM='"+userNamePref+"' WHERE USR_EML='"+email+"'";
                            }
                        }
                        else Logger.print("userNamePref is null");
                    }
                }
            }
            return true;
    ...
    private void setupSimplePreferencesScreen() {
        ...
        //bindPreferenceSummaryToValue(findPreference(getString(R.string.key_map_type_list)));
